...
"""Client and db_server classes corresponding to protobuf-defined services."""
import grpc
import warnings
...
class BridgeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Replicate = channel.unary_unary(
            '/replication.Bridge/Replicate',
            request_serializer=replication__pb2.Command.SerializeToString,
...
def add_BridgeServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'Replicate': grpc.unary_unary_rpc_method_handler(
            servicer.Replicate,
            request_deserializer=replication__pb2.Command.FromString,
            response_serializer=replication__pb2.Response.SerializeToString,
        ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
        'replication.Bridge', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('replication.Bridge', rpc_method_handlers)
...
class Bridge(object):
    ...
    def Replicate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/replication.Bridge/Replicate',
            replication__pb2.Command.SerializeToString,
